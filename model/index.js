...
// const router = require("./routes/crimeRoutes");

// const { commitedCrime, partOfC8, judgeDecision, crimePlace } = require("./getAnswer");
...
//     res.write(`${victimGetCorps.nameState}, you are welcome to the game!\n`);
//     res.write(`Enter two number that the SUM is equal to the clue number given in class. 
//     curl http://localhost:3000/number?firstNumber={}&secondNumber={}`);
...
//     res.send(partOfInceptionC8 + " curl http://localhost:3000/crime");
// });
